...
$(document).ready(function () {
    if(operation == "insert"){
        requestUrl = "/api/speak/Book.php?action="+operation+"Book&categoryId="+categoryId;
    }
    if (operation == "update") {
        requestUrl = "/api/speak/Book.php?action="+operation+"Book&bookId="+bookId;
        $.ajax({
            async:true,
            dataType:"json",
            type:"GET",
            url: "/api/speak/Book.php?action=getBookList&bookId="+bookId,
